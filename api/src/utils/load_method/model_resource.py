...
from src.models.bots import BotSummarize, BotChat, BotSLearn, BotDefault, BotRealtime, BotOraichain, BotCourseBlockchain, BotCheckComment
...
@register_load_method
def load_bot_default():
    model = BotDefault()
    return model  

@register_load_method
def load_bot_realtime():
    model = BotRealtime()
    return model  


@register_load_method
def load_bot_oraichain():
    model = BotOraichain()
    return model  


@register_load_method
def load_bot_course_blockchain():
    model = BotCourseBlockchain()
    return model  

@register_load_method
def load_bot_checkcomment():
    model = BotCheckComment()
    return model  